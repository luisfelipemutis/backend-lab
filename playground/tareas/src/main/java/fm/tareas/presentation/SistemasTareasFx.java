package fm.tareas.presentation;

import fm.tareas.TareasApplication;
...
public class SistemasTareasFx extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        loader.setControllerFactory(applicationContext::getBean); // Set the controller factory to use Spring's application context
